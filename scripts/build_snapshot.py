...
COMMON_STARTERS=LEGACY_STARTERS+[239,81,240,236]
STARTERS=LEGACY_STARTERS+[147,239,81,240,236,133]
HATCH_TABLE=[{'id':i,'weight':94} for i in COMMON_STARTERS]+[{'id':147,'weight':13},{'id':133,'weight':65}]
...
locationNames={int(r['location_id']):r['name'] for r in t['location_names'] if r['local_language_id']=='3'}
