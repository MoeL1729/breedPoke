import {abilityNotes} from './abilities.js?v=pokegotchi-271';
import { Game, freshState, migrateState, validateState, statsFor, clamp, ITEMS, shopCatalog, captureChance, SHINY_CHANCE, medicineUsable, TRAINERS, abilityOf, abilityItemTarget, HIDDEN_CHANCE, DROP_CHANCE } from './engine.js?v=pokegotchi-271';
