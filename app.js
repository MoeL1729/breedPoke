...
const typeImage=t=>`<img class="type-image" src="assets/types/${t}.png" alt="" width="64" height="28">`;
const badge=t=>`<span class="type-badge" style="${typeSkin(t)}">${typeImage(t)}<span>${esc(db.types[t].name)}</span></span>`;
